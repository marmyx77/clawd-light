        ...
        TestCase("The directory name replaces every non-alphanumeric character") { t in
            t.expectEqual(
                TranscriptLocator.directoryName(
                    forWorkspace: "/Users/dev/Development/lampboard"
                ),
...
enum DeliveredMessageSuite {
    ...
    static let suite = TestSuite("Delivered messages", [
        ...
        TestCase("The recorded envelope decodes to what the user typed") { t in
            let recorded = "<task-notification>\n<summary>message from the lampboard panel</summary>\n</task-notification>\n<system-reminder>\nThe user sent this from the lampboard panel instead of the editor. Treat it as their next turn and reply to it directly: Read secret.txt and tell me the codeword.\n</system-reminder>"
