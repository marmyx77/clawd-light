...
public enum ReleaseFeed {
    ...
    public static let latestReleaseURL = URL(
        string: "https://api.github.com/repos/marmyx77/clawd-light/releases/latest"
    )!

    /// The only prefix a downloadable asset may have.
    public static let downloadPrefix = "https://github.com/marmyx77/clawd-light/releases/download/"
