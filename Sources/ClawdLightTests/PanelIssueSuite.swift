...
enum PanelIssueSuite {
    ...
    static let suite = TestSuite("Panel issues", [
        ...
        TestCase("The stale-entry cure clears every hidden record, not the visible one") { t in
            ...
            // com.clawdlight.app, of which the list showed one, switched on, while
            ...
            t.expect(cure.contains("tccutil reset Accessibility com.clawdlight.app"),
                         "the accessibility record")
            t.expect(cure.contains("tccutil reset AppleEvents com.clawdlight.app"),
