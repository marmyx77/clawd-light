...
`Sources/TestKit/Assertions.swift` made all 504 domain tests report success
...
|---|---|---|---|---|---|
| Domain suite (504 cases) | the pure logic behaves | filesystem | `bite.sh --swift` breaks a comparison and demands exit 1 | CI, `test.sh` | 1.9 s |
