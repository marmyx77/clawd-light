...
```bash
swift run LampBoardTests              # 627 cases, instantaneous
swift run LampBoardE2E                # 88 cases, about a minute
...
early `return` added to `expect` once made all 627 cases report success while
