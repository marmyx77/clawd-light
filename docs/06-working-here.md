...
```bash
swift run LampBoardTests              # 586 cases, instantaneous
...
early `return` added to `expect` once made all 586 cases report success while
...
- **small files**: 200–400 lines typical, 800 the limit; the longest today is 772
