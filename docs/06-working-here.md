...
```bash
swift run LampBoardTests              # 593 cases, instantaneous
...
early `return` added to `expect` once made all 593 cases report success while
...
- **small files**: 200–400 lines typical, 800 the limit; the longest today is 764
