...
```bash
swift run LampBoardTests              # 645 cases, instantaneous
swift run LampBoardE2E                # 89 cases, about a minute
...
early `return` added to `expect` once made all 645 cases report success while
...
- **small files**: 200–400 lines typical, 800 the limit; the longest today is 791
