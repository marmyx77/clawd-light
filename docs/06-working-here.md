...
```bash
swift run ClawdLightTests              # 416 cases, instantaneous
swift run ClawdLightE2E                # 75 cases, about a minute
...
- **small files**: 200–400 lines typical, 800 the limit; the longest today is 612
