...
```bash
swift run LampBoardTests              # 570 cases, instantaneous
...
early `return` added to `expect` once made all 570 cases report success while
...
- **small files**: 200–400 lines typical, 800 the limit; the longest today is 768
